...
public class Grid : MonoBehaviour {
    ...
    public void SwapPieces(GamePiece piece1, GamePiece piece2, int contador)
    {
    ...
    public void SwapAgain(GamePiece piece1, GamePiece piece2)
    {
...
public void EnteredPiece(GamePiece piece)
    ...
    public void ReleasePiece()
    {
        ...
        {
            SwapPieces(pressedPiece, enteredPiece,0);
        }
    }
